...
import VehicleEdit from "../component/VehicleEdit";
export default function Vehicles() {
  ...
  return (
    <div className="vehicles-page">
          ...
          <table className="table">
            ...
            <tbody>
              {filteredVehicles.map((vehicle) => (
                <tr key={vehicle.id}>
                  <td>{vehicle.user?.employee?.Fname} {vehicle.user?.employee?.Lname}</td>
                  ...
                  <td className={vehicle.insurance_date && new Date(vehicle.insurance_date) < new Date() ? "text-danger" : ""}>{vehicle.insurance_date ?? '—'}</td>              
                  <td> <div className="action-buttons">
                        <button className={`btn btn-edit`} onClick={() => {setEditModal(true),setselectedvehicle(vehicle)}}>Edit</button>
                      </div></td>
      ...
      {showEditModal && (
            <VehicleEdit
              onClose={() => {setEditModal(false), setselectedvehicle([])}}
