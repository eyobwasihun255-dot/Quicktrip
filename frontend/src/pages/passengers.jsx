                          ...
                          <table className="trips-table">
                            ...
                            <tbody>
                              {selectedPassenger.travel_history.map((trip) => (
                                <tr key={trip.id}>
                                  <td>{trip?.time ? new Date(trip.time).toLocaleDateString() : ''}</td>
                                  <td>{trip?.ticket?.route?.first_destination?.name || ''}</td>
                                  <td>{trip?.ticket?.route?.last_destination?.name || ''}</td>
                                  <td>{trip?.payment?.amount ? parseFloat(trip.payment.amount).toFixed(2) : ''} ETB</td>
                      ...
                      <div className="trip-info-grid">
                        <div className="trip-info-item">
                          ...
                          <div className="info-content">
                            ...
                            <div className="info-value">{selectedTrip?.time ? new Date(selectedTrip.time).toLocaleDateString() : ''}</div>
                          </div>
                        </div>
                        <div className="trip-info-item">
                          <div className="info-icon">🚗</div>
                          <div className="info-content">
                            ...
                            <div className="info-value">{[selectedTrip?.vehicle?.name, selectedTrip?.vehicle?.Model].filter(Boolean).join(' ')}</div>
                          </div>
                        </div>
                        <div className="trip-info-item">
                          <div className="info-icon">👤</div>
                        ...
                        <div className="trip-info-item">
                          ...
                          <div className="info-content">
                            ...
                            <div className="info-value">{selectedTrip?.payment?.amount ? parseFloat(selectedTrip.payment.amount).toFixed(2) : ''}</div>
                          </div>
                        </div>
                        <div className="trip-info-item">  
                          <div className="info-icon">🔄</div>
